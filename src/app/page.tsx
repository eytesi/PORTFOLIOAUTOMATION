  ...
  return (
    <>
      <h2 style={{ position: "absolute", width: "1px", height: "1px", overflow: "hidden", clip: "rect(0,0,0,0)" }}>
        Ivo Vieytes — portfolio de Process Improvement y QA Automation
      </h2>
        ...
        <div className="hero">
          ...
          <div className="hero-right">
            <div className="hcard">
              <div className="hcard-icon">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <rect x="2" y="2" width="6" height="6" rx="2" fill="#ff2d78" />
                  <rect x="12" y="2" width="6" height="6" rx="2" fill="#ff2d78" opacity="0.4" />
                  <rect x="2" y="12" width="6" height="6" rx="2" fill="#ff2d78" opacity="0.4" />
                  <rect x="12" y="12" width="6" height="6" rx="2" fill="#ff2d78" opacity="0.7" />
                </svg>
              </div>
            ...
            <div className="hcard">
              <div className="hcard-icon">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <circle cx="10" cy="10" r="7" stroke="#ff2d78" strokeWidth="2" />
            ...
            <div className="hcard">
              <div className="hcard-icon">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <path d="M10 2l2.4 5 5.6.8-4 3.9.9 5.5L10 14.5l-4.9 2.7.9-5.5L2 7.8l5.6-.8L10 2z" fill="#ff2d78" opacity="0.7" />
                </svg>
              </div>
        ...
        <div className={`tc${activeTrack === 0 ? " visible" : ""}`}>
          <div className="cases-wrap">
            ...
            <div onClick={() => toggleC("0")}>
              <div className={`crow${openCase === "0" ? " open" : ""}`}>
                <div className="cn">01</div>
                <div>
                  <div className="ctitle">I-9 Verification Process Redesign</div>
                  <div className="csub">End-to-end automation via stakeholder insight</div>
                  <div className="cpills">
                    <span className="cpill hot">Automation</span>
                    <span className="cpill hot">Compliance</span>
                    <span className="cpill">Stakeholder</span>
                  </div>
                </div>
            ...
            <div onClick={() => toggleC("1")}>
              <div className={`crow${openCase === "1" ? " open" : ""}`}>
                <div className="cn">02</div>
                <div>
                  <div className="ctitle">Work Authorization Reverification System</div>
                  <div className="csub">Automated outreach for expiring documents</div>
                  <div className="cpills">
                    <span className="cpill hot">Email Automation</span>
                    <span className="cpill hot">Compliance</span>
                    <span className="cpill">Risk Reduction</span>
                  </div>
                </div>
                <div className="carrow">›</div>
              </div>
            ...
            <div className={`cdetail${openCase === "1" ? " visible" : ""}`}>
              <div className="d3col">
                <div>
                  ...
                  <div className="dtext">Re-verifications required manually checking expiring work authorization documents in Perfect Compliance and sending reminder emails to employees at least every 7 days. The process was repetitive, time-consuming, and easy to delay during busy periods.</div>
                </div>
                <div>
                  <div className="dlabel">My role</div>
                  <div className="dtext">I owned the re-verification process and turned a manual workflow into an automated reminder system. I used the weekly re-verification report as the source table and built a flow that sends reminder emails automatically once documents are within 50 days of expiration.</div>
                </div>
                <div>
                  <div className="dlabel">Outcome</div>
                  <div className="dtext">The process now runs through a weekly refreshed table and sends recurring reminders automatically, reducing manual effort by at least 10 hours per month while improving consistency and visibility.</div>
                </div>
              </div>
              <div className="flow">
                <div className="fs"><div className="fd"></div><div className="fl">Weekly<br />report</div></div><div className="fa">→</div>
                <div className="fs"><div className="fd on"></div><div className="fl on">Table<br />refreshed</div></div><div className="fa">→</div>
                <div className="fs"><div className="fd on"></div><div className="fl on">50-day<br />filter</div></div><div className="fa">→</div>
                <div className="fs"><div className="fd on"></div><div className="fl on">Weekly email<br />sent</div></div><div className="fa">→</div>
                <div className="fs"><div className="fd"></div><div className="fl">Follow-up<br />tracked</div></div>
              </div>
              <div className="stats">
                <div className="scard"><div className="sgfx"><svg width="56" height="36" viewBox="0 0 56 36"><text x="28" y="24" textAnchor="middle" fontFamily="Figtree" fontSize="16" fontWeight="900" fill="#ff2d78">10h+</text></svg></div><div className="slabel">Saved monthly</div></div>
                <div className="scard"><div className="sgfx"><svg width="56" height="36" viewBox="0 0 56 36"><path d="M6 28 L18 22 L28 18 L40 10 L50 6" stroke="#ff2d78" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" /><circle cx="50" cy="6" r="2.5" fill="#ff2d78" /></svg></div><div className="slabel">Proactive follow-up</div></div>
                <div className="scard"><div className="sgfx"><svg width="56" height="36" viewBox="0 0 56 36"><rect x="4" y="22" width="8" height="12" rx="2" fill="#ff2d78" opacity="0.2" /><rect x="16" y="16" width="8" height="18" rx="2" fill="#ff2d78" opacity="0.4" /><rect x="28" y="10" width="8" height="24" rx="2" fill="#ff2d78" opacity="0.6" /><rect x="40" y="4" width="8" height="30" rx="2" fill="#ff2d78" opacity="0.9" /></svg></div><div className="slabel">Consistency ↑</div></div>
              </div>
            </div>

            <div onClick={() => toggleC("2")}>
              <div className={`crow${openCase === "2" ? " open" : ""}`}>
                <div className="cn">03</div>
                <div>
                  <div className="ctitle">Holiday Staffing Alert System</div>
                  <div className="csub">Proactive multi-location coverage reminders</div>
                  <div className="cpills">
                    <span className="cpill hot">Workforce Planning</span>
                    <span className="cpill hot">Ops Efficiency</span>
                    <span className="cpill">Multi-location</span>
                  </div>
                </div>
                <div className="carrow">›</div>
              </div>
            ...
            <div onClick={() => toggleC("3")}>
              <div className={`crow${openCase === "3" ? " open" : ""}`}>
            ...
            <div className={`cdetail${openCase === "3" ? " visible" : ""}`}>
              <div className="d3col">
                <div>
                  <div className="dlabel">Problem</div>
                  <div className="dtext">Teams relied on manual reminders for recurring operational deadlines and events, which made it easier to miss key actions during busy periods.</div>
                </div>
                <div>
                  <div className="dlabel">My role</div>
                  <div className="dtext">Built lightweight automated reminders for operational needs such as payroll deadlines and internal team coordination, reducing the need for repetitive manual follow-up.</div>
                </div>
                <div>
                  <div className="dlabel">Outcome</div>
                  <div className="dtext">Improved visibility of recurring deadlines, supported team alignment, and made small but high-friction operational tasks more consistent.</div>
                </div>
              </div>
              <div className="flow">
              ...
              <div className="stats">
                <div className="scard"><div className="sgfx"><svg width="56" height="36" viewBox="0 0 56 36"><path d="M6 28 L18 20 L30 22 L42 12 L50 8" stroke="#ff2d78" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" /><circle cx="50" cy="8" r="2.5" fill="#ff2d78" /></svg></div><div className="slabel">Visibility ↑</div></div>
                <div className="scard"><div className="sgfx"><svg width="56" height="36" viewBox="0 0 56 36"><circle cx="28" cy="18" r="13" fill="rgba(255,45,120,0.08)" stroke="#ff2d78" strokeWidth="1.5" /><path d="M20 18l5.5 5.5 10-10" stroke="#ff2d78" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg></div><div className="slabel">Consistency</div></div>
                <div className="scard"><div className="sgfx"><svg width="56" height="36" viewBox="0 0 56 36"><rect x="6" y="22" width="8" height="12" rx="2" fill="#ff2d78" opacity="0.3" /><rect x="18" y="14" width="8" height="20" rx="2" fill="#ff2d78" opacity="0.5" /><rect x="30" y="8" width="8" height="26" rx="2" fill="#ff2d78" opacity="0.7" /><rect x="42" y="3" width="8" height="31" rx="2" fill="#ff2d78" opacity="0.9" /></svg></div><div className="slabel">Manual effort ↓</div></div>
              </div>
            </div>
                ...
                {timeline.map((item, index) => (
                  <div className="tli" key={index}>
                    ...
                    <div>
                      ...
                      <div className="tldesc">{item.subtitle}</div>
                    </div>
                  </div>
                ))}
              </div>
